...
#define MACHINE_NAME "Julia Pro Dual with TMC 2208 on MKS GenL V2.1, Not using UART- Top right 2 jumpers jumped horizontally, 1/16 micro stepping, with RPi 4"
